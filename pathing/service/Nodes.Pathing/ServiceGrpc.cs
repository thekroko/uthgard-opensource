...
namespace Nodes.Pathing {
  public static partial class PathingService
  {
    ...
    static readonly Method<global::Nodes.Pathing.PathingRequest, global::Nodes.Pathing.PathingResponse> __Method_GetPathStreamed = new Method<global::Nodes.Pathing.PathingRequest, global::Nodes.Pathing.PathingResponse>(
    ...
    public abstract partial class PathingServiceBase
    {
      ...
      public virtual global::System.Threading.Tasks.Task GetPathStreamed(IAsyncStreamReader<global::Nodes.Pathing.PathingRequest> requestStream, IServerStreamWriter<global::Nodes.Pathing.PathingResponse> responseStream, ServerCallContext context)
      {
        throw new RpcException(new Status(StatusCode.Unimplemented, ""));
      }
    ...
    public partial class PathingServiceClient : ClientBase<PathingServiceClient>
    {
      ...
      public virtual AsyncDuplexStreamingCall<global::Nodes.Pathing.PathingRequest, global::Nodes.Pathing.PathingResponse> GetPathStreamed(Metadata headers = null, DateTime? deadline = null, CancellationToken cancellationToken = default(CancellationToken))
      {
        return GetPathStreamed(new CallOptions(headers, deadline, cancellationToken));
      }
      public virtual AsyncDuplexStreamingCall<global::Nodes.Pathing.PathingRequest, global::Nodes.Pathing.PathingResponse> GetPathStreamed(CallOptions options)
      {
